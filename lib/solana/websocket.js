...
// from the market-data POLLING that happens elsewhere (DexScreener).
...
const MIN_TX_LOOKUP_INTERVAL_MS = Number(process.env.MIN_TX_LOOKUP_INTERVAL_MS || 400);
...
const PROGRAM_MINT_ACCOUNT_INDICES = {
  "675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8": [8, 9],
  "whirLbMiicVdio4qvUfM5KAg6Ct8VwpYzGff3uctyCc": [1, 2],
  "6EF8rrecthR5Dkzon8Nwu78hRvfCKubJ14M5uBEwF6P": [0]
};
  ...
  _connect() {
    ...
    try {
      this.connection = new Connection(this.httpUrl, {
        ...
        // backoff — independent of MIN_TX_LOOKUP_INTERVAL_MS above. Those
        // internal retries still count against Helius' rate limit, silently
        // multiplying our real request volume. Disabling this makes our
        // external rate limiting the only thing in control.
