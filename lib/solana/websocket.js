...
// Each matched transaction can list 20-50+ accounts, but only checking all
// of them against DexScreener overwhelms the throttled downstream lookup —
// most candidates from a busy transaction were being dropped before ever
// getting checked, likely including the real new mint. Anchor-style
// instructions commonly list newly-created/signer accounts earliest, so
// keeping only the first few per transaction concentrates our limited
// lookup budget on the addresses most likely to matter.
